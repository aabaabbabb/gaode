package com.jinyan.kit.directive;
 ...
 *
 * 使用示例见模板文件： /_view/_admin/project/index.html 或�?? /_view/_admin/permission/index.html
...
public class PermissionDirective extends Directive {
	...
	private String getPermission(Scope scope) {
		...
		if (value instanceof String) {
			...
			throw new IllegalArgumentException("权限参数只能�? String 类型");
		}
	}
