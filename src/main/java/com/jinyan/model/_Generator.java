...
import com.jinyan.common.AppConfig;
...
public class _Generator {
	...
	private static final String[] blacklist = {
 		// "hotel", //  还是自动生成吧，不同的字段，通过转换方法，转换 ，参考 	List<Map<String, Object>> hotelListNew= hsrv.modelsGaode(  hotelList);
	...
	public static void main(String[] args) {
		...
		String modelPackageName = "com.jinyan.model";
		...
		gen.setRemovedTableNamePrefixes("gd_");
		// 设置是否生成字典文件
